...
String sonucSaysi=driver.findElement(By.id("result")).getText();
    Assert.assertEquals(sonucSaysi,"You successfuly clicked an alert");
    }
    @Test
    public void dismissTest() throws InterruptedException {
        ...
        Assert.assertFalse(sonucYazisi.contains("succesfully"));
    }
    @Test
    public void sendKeysAlert() throws InterruptedException {
        ...
        Thread.sleep(3000);
        driver.switchTo().alert().sendKeys("mucahit");
        Thread.sleep(3000);
        driver.switchTo().alert().accept();
        Thread.sleep(3000);
        String sonucYazisi=driver.findElement(By.id("result")).getText();
        Assert.assertTrue(sonucYazisi.contains("mucahit"));
    }
    @AfterClass
